...
export default function Navbar() {
  return (
<nav class=" bg-transparent border-gray-200 dark:bg-gray-900 dark:border-gray-700 bg-gradient-to-tr from-[#101828] to-[#3C288A] text-white">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                    ...
                    <div id="doubleDropdown" class="z-10 hidden   divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
